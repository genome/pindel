...
void build_record_RP_Discovery (const bam1_t * r1, void *data)
{
    ...
    if (!(r1_core->flag & BAM_FUNMAP || r1_core->flag & BAM_FMUNMAP)) { // both reads are mapped.
        ...
        if ((r1_core->tid != r1_core->mtid) || abs(r1_core->isize) > 2 * data_for_bam->InsertSize + 1000 || ((r1_core->flag & BAM_FREVERSE) == (r1_core->flag & BAM_FMREVERSE))) { // different chr or same strand or insert is too large
