...
extern int NumRead2ReportCutOff;
...
std::vector <std::string> ReverseComplement(const std::vector <std::string> & input);
std::string ReverseComplement(const std::string & InputPattern);
std::string Cap2Low(const std::string & input);
void GetRealStart4Insertion(const std::string & TheInput, const std::string & InsertedStr, unsigned int & RealStart, unsigned int & RealEnd);
...
void GetFarEnd_BothStrands(const std::string & CurrentChr, SPLIT_READ & Temp_One_Read, const short & RangeIndex);
...
bool NotInVector(const std::string & OneTag, const std::vector <std::string> & VectorTag);
void GetIndelTypeAndRealStart(const std::string & TheInput, const unsigned int & BPLeft, 
                              const unsigned int & IndelSize, const std::string & IndelStr, 
                              std::string & IndelType, unsigned int & RealStart, const bool & WhetherD);
